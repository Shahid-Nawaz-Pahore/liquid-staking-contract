...
export const compile: CompilerConfig = {
    ...
    targets: [
        ...
        'contracts/jetton_dao/contracts/auto/jetton-wallet-code.func',
    ...
    postCompileHook: async (code) => {
        ...
        await writeFile(
            path.join(auto, 'voting-code.func'),
            `cell voting_code() asm "B{${code.toBoc().toString('hex')}} B>boc PUSHREF";`
        );
    }
};
