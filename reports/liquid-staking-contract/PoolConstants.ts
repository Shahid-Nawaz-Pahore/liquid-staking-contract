...
export abstract class Op {
    ...
    static readonly pool = {
        ...
        touch: 0x4bc7c2df,
        donate: 0x73affe21,
        // Proxy Admin Operations (Pool acts as Jetton admin)
        admin_mint: 0xA1B2C301,
        admin_burn: 0xA1B2C302,
        admin_transfer: 0xA1B2C303,
        freeze_wallet: 0xA1B2C304,
        unfreeze_wallet: 0xA1B2C305,
        set_freeze_period: 0xA1B2C306
    }
